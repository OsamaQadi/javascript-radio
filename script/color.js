...
this.select_color(localStorage.getItem("COLOR"));
    ...
    select_color(color){
if(color=="color1"){
document.body.style.background = "#53b9ac";
} else if(color=="color2"){
    document.body.style.background = "linear-gradient(to right, #FF99CC, #3333FF)";
    }
    else if(color=="color3"){
        document.body.style.background = "linear-gradient(to right, #FF99CC, #99FF33)";
        }
        else if(color=="color4"){
            document.body.style.background = "linear-gradient(to right, #0000FF, #FFFFFF)";
            }
