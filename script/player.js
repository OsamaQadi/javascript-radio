...
this.names_radio = [];
this.names_radio[0]="إذاعة الرياض";
this.names_radio[1]="إذاعة جدة";
this.names_radio[2]="مكس FM";
this.names_radio[3]="راديو روتانا";
this.names_radio[4]="إذاعة القرآن";

this.source_audio = [];
this.source_audio[0]="http://87.98.130.255:8234/stream";
this.source_audio[1]="http://87.98.130.255:8509/stream"; 
this.source_audio[2]="http://s2.voscast.com:11376/live"; 
this.source_audio[3]="http://philae.shoutca.st:8114/;stream.mp3";
this.source_audio[4]="http://live2.badrshfaqah.sa:8027/stream";
this.server = 0;
...
document.getElementById("back").addEventListener("click", ()=>{
    if(this.server>0){
       ...
       this.server=this.source_audio.lenght-1;
    }
    localStorage.setItem("SAVE-POSITION", this.server);
    this.setResource();
});
